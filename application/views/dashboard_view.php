...
<div class="tile-stats" style="background: green;">
<div class="icon" style="color: black;"><i class="fa fa-users"></i></div>
<div class="count" style="color: black;">
<?php echo $agtCount ?>
</div>
<h3 style="color: black;">Anggota</h3>
<p style="color: black;">Jumlah anggota terdaftar</p>
</div>
</div>
<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
<div class="tile-stats" style="background: yellow;">
<div class="icon" style="color: black;"><i class="fa fa-book"></i></div>
<div class="count" style="color: black;">
<?php echo $bkCount ?>
</div>
<h3 style="color: black;">Buku</h3>
<p style="color: black;">Jumlah judul buku</p>
</div>
</div>
<?php if($this->session->userdata('role')=='superadmin'): ?>
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
    <div class="tile-stats" style="background: red;">
    <div class="icon" style="color: black;"><i class="fa fa-user"></i></div>
    <div class="count" style="color: black;">
    <?php echo $ptgCount ?>
    </div>
    <h3 style="color: black;">Petugas</h3>
    <p style="color: black;">Jumlah petugas terdaftar</p>
    </div>
    </div>
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
    <div class="tile-stats" style="background: blue;">
    <div class="icon" style="color: black;"><i class="fa fa-list-alt"></i></div>
    <div class="count" style="color: black;">
    <?php echo $trnCount ?>
    </div>
    <h3 style="color: black;">Transaksi</h3>
    <p style="color: black;">Total jumlah transaksi</p>
    </div>
    </div>
    <?php else: ?>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
        <div class="tile-stats" style="background: red;">
        <div class="icon" style="color: black;"><i class="fa fa-arrow-up"></i></div>
        <div class="count" style="color: black;">
        <?php echo $pnjCount ?>
        </div>
        <h3 style="color: black;">Peminjaman</h3>
        <p style="color: black;">Jumlah peminjaman belum kembali</p>
        </div>
        </div>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
        <div class="tile-stats" style="background: blue;">
        <div class="icon" style="color: black;"><i class="fa fa-arrow-down"></i></div>
        <div class="count" style="color: black;">
        <?php echo $kmbCount ?>
        </div>
        <h3 style="color: black;">Pengembalian</h3>
        <p style="color: black;">Jumlah peminjaman sudah kembali</p>
        </div>
        </div>
        <?php endif; ?>
        </div>
